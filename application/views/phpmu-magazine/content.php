			...
			<div class="block">
				...
				<div class="block-content">
					<ul class="article-block">
						<?php 
							$no = 1;
							$hot = $this->model_utama->view_join_two('berita','users','kategori','username','id_kategori',array('status' => 'Y'),'tanggal','DESC',0,4);
						...
						?>
							...
							<a href="https://polrestabesplg.sumsel.polri.go.id/kategori/detailall">History Berita</a>
				</div>
				<center>
							 <?php
			 	echo "<a class='hover-effect' href='https://polrestabesplg.sumsel.polri.go.id/kategori/detailall'>  <img style='width:59px; height:32px' src='https://www.ualberta.ca/history-classics/media-library/history-banner' />
