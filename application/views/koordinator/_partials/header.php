...
<?php
}elseif ($this->uri->segment(2) == "modules_datatables" || $this->uri->segment(2) == "users" ) { ?>
...
}elseif  ( $this->uri->segment(2) != "index" &&  $this->uri->segment(2) != "logout" &&  $this->uri->segment(2) != "auth_login" &&  $this->uri->segment(2) != "" && $this->uri->segment(2) != "auth_forgot_password"&& $this->uri->segment(2) != "auth_register" && $this->uri->segment(2) != "auth_reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
   
  $this->load->view('web/_partials/layout');
  $this->load->view('koordinator/_partials/sidebar');
}
?>
