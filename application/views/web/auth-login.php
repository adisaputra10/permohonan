        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php $this->uri->segment(1).'/web/index' ?>" class="needs-validation" novalidate="">
            ...
            <div class="mt-5 text-muted text-center">
              Belum punya akun? <a href="<?php echo base_url(); ?>web/auth_register">Daftar</a>
            </div>
...
<?php $this->load->view('web/_partials/js'); ?>